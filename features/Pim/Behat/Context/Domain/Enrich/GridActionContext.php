...
class GridActionContext extends PimContext
{
    ...
    {
        $this->getCurrentPage()->getCurrentGrid()->openColumnsPopin();
        $this->wait();
        $this->getCurrentPage()->getCurrentGrid()->hideColumn($column);
        $this->wait();
    }
    ...
    public function iPutTheColumnBeforeTheOne($source, $target)
    {
        $this->getCurrentPage()->getCurrentGrid()->openColumnsPopin();
        $this->wait();
        $this->getCurrentPage()->getCurrentGrid()->moveColumn($source, $target);
        $this->wait();
    }
